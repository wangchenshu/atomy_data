    ...
    while 'paging' in res.json(): 
        for information in res.json()['data']:
            if 'message' in information:
                information_list.append([fanpage[ele], information['id'], information['message'], parse(information['created_time'])])
...
information_df = pd.DataFrame(information_list, columns=['fans_page', 'id', 'message', 'created_time'])
